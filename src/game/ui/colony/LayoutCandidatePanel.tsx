...
export function LayoutCandidatePanel({ candidates, onNewSeed, onSelect, onSelectDefault, seedSweep, selectedIndex, showDefaultOption, selectedMode }: LayoutCandidatePanelProps) {
