...
import type { ProtocolActionRequest, ProtocolLiteral, ProtocolNode } from '../../src/game/domain/protocol/Protocol';
import { PHASE_THREE_BASELINE_CONFIG, type SimulationConfig } from '../../src/game/simulation/SimulationConfig';
...
import { ProtocolRuntime } from '../../src/game/simulation/protocol/protocolRuntime';
import {
  andProtocol,
  delayedProtocol,
  directProtocol,
